...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  ...
  <!-- 
	...
	List<User> list=UserDao.getRecords();  
        System.out.println(";ist in jsp " + list.size());
	request.setAttribute("list",list);  
	%>  
	  
	<table border="1" width="90%">  
            <tr><th>FIRST NAME</th><th>LAST NAME</th><th>PROFESSION</th><th>QUALIFICATION</th><th>PHONE NUMBER</th><th>EMAIL</th>  
	<th>SEX</th><th>COUNTRY</th><th>Delete</th></tr>  
	<c:forEach items="${list}" var="u">  
	<tr><td>${u.getFirstname()}</td><td>${u.getLastname()}</td><td>${u.getProfession()}</td>
            <td>${u.getQualification()}</td><td>${u.getPhonenumber()}</td>
